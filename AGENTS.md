# Google Analytics 4 Printed CLI Agent Guide

This directory is a generated `ga4-pp-cli` printed CLI. It was produced by [CLI Printing Press](https://github.com/mvanhorn/cli-printing-press), so treat systemic fixes as upstream Printing Press fixes first. Keep local edits narrow and document why a generated-tree patch belongs here.
...
ga4-pp-cli agent-context --pretty
```

Use runtime discovery instead of relying on a copied command list:

```bash
ga4-pp-cli which "<capability>" --json
ga4-pp-cli <command> --help
```
...
```bash
ga4-pp-cli <command> --help
ga4-pp-cli <command> --dry-run --agent
```
