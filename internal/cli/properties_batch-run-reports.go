...
func newPropertiesBatchRunReportsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&bodyRequests, "requests", "", "Individual requests. Each request has a separate report response. Each batch request is allowed up to 5 requests.")
